...
import { ChannelPartnerEmployeesController } from '../core/dashboard.controller.js';
...
@Module({
  ...
  controllers: [ChannelPartnerDashboardController, ChannelPartnerEmployeesController],
  providers: [
