...
export function Widget({ icon, label, value, sub, accent = "indigo", dark = false }: any) {
  ...
  if (dark) return (
    <div className="bg-slate-900 text-white rounded-3xl p-5 border border-slate-800 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
      <div className="absolute -right-6 -bottom-6 w-28 h-28 bg-emerald-500/20 rounded-full blur-2xl pointer-events-none" />
