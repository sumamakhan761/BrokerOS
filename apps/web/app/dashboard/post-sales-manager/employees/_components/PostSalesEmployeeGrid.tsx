...
export function PostSalesEmployeeGrid({ employees, loading }: PostSalesEmployeeGridProps) {
            ...
            >
              ...
              <div className="space-y-4 pt-4 border-t border-slate-100">
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-bold text-emerald-700">{emp.stats.totalBookings || 0}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <div className="flex items-center gap-2 text-slate-600">
                  ...
                  <span className="font-bold text-orange-600">{emp.stats.pendingDocs || 0}</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <div className="flex items-center gap-2 text-slate-600">
                    <Landmark className="w-4 h-4 text-indigo-400" />
                    <span className="font-medium">Loan Cases</span>
                  </div>
                  <span className="font-bold text-indigo-600">{emp.stats.loanCases || 0}</span>
                </div>
              </div>
            </Link>
          ))}
