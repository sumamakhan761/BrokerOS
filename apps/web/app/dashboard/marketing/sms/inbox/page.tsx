...
export default function SmsInboxPage() {
  return (
    <div className="p-4 md:p-6 max-w-[1600px] mx-auto">
      <div className="mb-4">
        <h1 className="text-xl font-bold text-slate-900 tracking-tight">SMS Live Team Inbox</h1>
      ...
      <Suspense fallback={<div className="p-8 text-center text-xs text-slate-400">Loading SMS Inbox...</div>}>
        <SmsInboxView />
      </Suspense>
    </div>
  );
