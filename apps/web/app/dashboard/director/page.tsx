...
import { BarChart, AlertCircle, CheckCircle2 } from "lucide-react";
...
export default function DirectorDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const res = await authClient.$fetch('/dashboard/director', {
        ...
        <div className="space-y-6">
          <div className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm relative overflow-hidden">
            ...
            <p className="text-gray-600 mb-6 relative z-10">
              The backend verified your role and authorized access to the Director Dashboard.
            </p>
