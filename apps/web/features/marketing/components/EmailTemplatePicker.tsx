      ...
      {REAL_ESTATE_TEMPLATES.map((tmpl) => {
        ...
        return (
          <div
            ...
            className={`relative p-4 rounded-2xl border-2 cursor-pointer transition-all duration-150 active:scale-[0.99] flex flex-col justify-between ${isSelected
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <div
                    className={`w-7 h-7 rounded-xl flex items-center justify-center ${isSelected
                ...
                <span
                  className={`text-[10px] font-extrabold px-2 py-0.5 rounded-full ${isSelected
