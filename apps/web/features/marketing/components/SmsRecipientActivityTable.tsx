...
import type { SmsRecipientItem } from "../types";
import { Button } from "@/components/ui/Button";
import { Badge } from "@/components/ui/Badge";

interface SmsRecipientActivityTableProps {
  recipients: SmsRecipientItem[];
  loading?: boolean;
  onPromote?: (recipientId: string) => Promise<void>;
}

export function SmsRecipientActivityTable({
  recipients,
  loading,
  onPromote,
}: SmsRecipientActivityTableProps) {
