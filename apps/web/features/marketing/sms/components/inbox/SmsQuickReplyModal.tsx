// ============================================================================
// BrokerOS — SMS Quick Replies Picker & Manager Modal (Client-side & Offline-first)
// ============================================================================
...
const STORAGE_KEY = 'brokeros_sms_quick_replies';
  ...
  const persistReplies = (updated: SmsQuickReplyItem[]) => {
    ...
    if (typeof window !== 'undefined') {
      try {
        ...
        window.dispatchEvent(new Event('brokeros_sms_quick_replies_changed'));
      } catch (e) {
