        ...
        <View style={{ flexDirection: 'column', gap: 12 }}>
          {employees.map((emp) => (
            <TouchableOpacity
              ...
              onPress={() => router.push(`/(dashboard)/post-sales-manager/employees/${emp.id}` as any)}
            >
              <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                ...
                <View style={{ marginLeft: 12, flex: 1 }}>
                  ...
                  <View style={{ flexDirection: 'row', gap: 12, marginTop: 6 }}>
                    <Text style={{ fontSize: 12, color: '#64748b' }}><Text style={{ fontWeight: 'bold', color: '#6366f1' }}>{emp.stats.totalBookings}</Text> Bookings</Text>
                    <Text style={{ fontSize: 12, color: '#64748b' }}><Text style={{ fontWeight: 'bold', color: '#10b981' }}>{emp.stats.pendingDocs}</Text> Docs Pend.</Text>
                    <Text style={{ fontSize: 12, color: '#64748b' }}><Text style={{ fontWeight: 'bold', color: '#3b82f6' }}>{emp.stats.loanCases}</Text> Loan Cases</Text>
                  </View>
                </View>
              </View>
