...
import { ChevronRight, Users, PhoneCall } from 'lucide-react-native';
...
export function TeamMembersList({ employees }: { employees: Employee[] }) {
  ...
  const handlePress = (id: string) => {
    ...
    router.push(`/pre-sales-manager/employees/${id}` as any);
  };
