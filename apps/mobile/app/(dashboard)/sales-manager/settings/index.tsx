    ...
    <View className="flex-1 bg-[#f8fafc] p-6">
      <View className="flex-row items-center mb-8">
        ...
        <View>
          ...
          <Text className="text-gray-500 text-sm">Manager preferences</Text>
        </View>
      </View>
      ...
      <View className="bg-white rounded-3xl shadow-sm border border-gray-100 mb-20 overflow-hidden">
        <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
          ...
          <View className="flex-1">
            ...
            <Text className="text-sm text-gray-500">Update your details</Text>
          </View>
        ...
        <TouchableOpacity className="flex-row items-center p-4 border-b border-gray-100">
          ...
          <View className="flex-1">
            ...
            <Text className="text-sm text-gray-500">Team alerts and reports</Text>
          </View>
          <Feather name="chevron-right" size={20} color="#cbd5e1" />
        </TouchableOpacity>
      </View>
