...
export default function MoreMenuScreen() {
  ...
  const menuItems = [
    { title: 'Broker Management', icon: 'users', route: '/(dashboard)/closing-manager/broker-management', color: '#2563eb', bg: 'bg-blue-100' },
    { title: 'Handover', icon: 'clipboard', route: '/(dashboard)/closing-manager/handover', color: '#0d9488', bg: 'bg-teal-100' },
    { title: 'Analytics', icon: 'pie-chart', route: '/(dashboard)/closing-manager/analytics', color: '#10b981', bg: 'bg-emerald-100' },
    { title: 'Settings', icon: 'settings', route: '/(dashboard)/closing-manager/settings', color: '#475569', bg: 'bg-slate-100' },
  ];
