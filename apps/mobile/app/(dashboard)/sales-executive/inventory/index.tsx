...
export default function SalesExecutiveInventoryIndex() {
  ...
  return (
    <View className="flex-1 bg-slate-50">
      ...
      <View className="p-6 pt-12 bg-white border-b border-slate-200">
        <Text className="text-2xl font-bold text-slate-900">My Projects</Text>
        <Text className="text-sm text-slate-500 mt-1">View live availability and book units.</Text>
      </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View className="py-20 items-center justify-center">
              ...
              <Text className="text-slate-500 text-center mt-2 px-8">You haven&apos;t been assigned to any projects yet.</Text>
            </View>
          }
          renderItem={({ item: project }) => (
            <TouchableOpacity
              onPress={() => router.push(`/sales-executive/inventory/${project.id}` as any)}
            ...
            >
              ...
              <View className="mt-4 pt-4 border-t border-slate-100 flex-row justify-between items-center">
                ...
                <View className="flex-row items-center bg-indigo-50 px-3 py-1.5 rounded-lg">
                  <Text className="text-indigo-700 font-bold mr-1">Book Unit</Text>
