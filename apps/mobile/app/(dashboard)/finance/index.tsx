  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const res = await authClient.$fetch('/dashboard/finance', { baseURL });
        setData(res);
      } catch (err: any) {
  ...
  return (
    <View className="flex-1 bg-[#f8fafc] p-6">
      <View className="items-center mb-8">
        ...
        <Text className="text-2xl font-bold text-gray-900">Finance CRM</Text>
        <Text className="text-gray-500 text-center mt-2">Manage payments and ledgers.</Text>
      </View>
