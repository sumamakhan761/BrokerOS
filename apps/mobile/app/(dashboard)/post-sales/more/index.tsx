...
import { ClipboardCheck, PieChart, Settings, ChevronRight, Menu } from 'lucide-react-native';
import { useRouter } from 'expo-router';
import * as Haptics from 'expo-haptics';

export default function PostSalesMoreMenuScreen() {
  const router = useRouter();

  const menuItems = [
    {
      title: 'Handover',
      description: 'Unit possession & key handovers',
      icon: ClipboardCheck,
      route: '/(dashboard)/post-sales/handover',
      iconColor: '#059669',
    ...
    {
      title: 'Analytics',
      description: 'Post-sales performance & reports',
      icon: PieChart,
      route: '/(dashboard)/post-sales/analytics',
      iconColor: '#2563eb',
      bgColor: 'bg-blue-50',
    ...
    {
      title: 'Settings',
      description: 'Account preferences & app configuration',
      icon: Settings,
      route: '/(dashboard)/post-sales/settings',
      iconColor: '#475569',
