...
import { CreditCard, ClipboardCheck, PieChart, Settings, ChevronRight, Menu } from 'lucide-react-native';
import { useRouter } from 'expo-router';
import * as Haptics from 'expo-haptics';

export default function PostSalesManagerMoreMenuScreen() {
  const router = useRouter();

  const menuItems = [
    {
      title: 'Commissions',
      description: 'Inbound builder payouts & settlements',
      icon: CreditCard,
      route: '/(dashboard)/post-sales-manager/commissions',
      iconColor: '#2563eb',
      bgColor: 'bg-blue-50',
    ...
    {
      title: 'Handover',
      description: 'Unit possession & key handover tracking',
      icon: ClipboardCheck,
      route: '/(dashboard)/post-sales-manager/handover',
      iconColor: '#059669',
    ...
    {
      title: 'Analytics',
      description: 'Team performance & conversion reports',
      icon: PieChart,
      route: '/(dashboard)/post-sales-manager/analytics',
      iconColor: '#7c3aed',
    ...
    {
      title: 'Settings',
      description: 'Manager account & system preferences',
      icon: Settings,
      route: '/(dashboard)/post-sales-manager/settings',
      iconColor: '#475569',
      ...
      <View className="px-5 pt-2 pb-5">
        <View className="flex-row items-center gap-3 mb-1">
          ...
          <View>
            ...
            <Text className="text-xs font-semibold text-slate-500 mt-0.5">Additional management tools & settings</Text>
          </View>
        </View>
      </View>
