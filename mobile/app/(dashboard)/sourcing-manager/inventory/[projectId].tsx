...
export default function SourcingManagerProjectInventory() {
  ...
  const handleUnitClick = (unit: any, floor: any) => {
    ...
    // Sourcing Managers can only view info, not book. So we always show the Info Modal.
          ...
          <View className="flex-1 p-4">
            {towers.length === 0 ? (
              <View className="flex-1 items-center justify-center">
                ...
                <Text className="text-slate-500 text-center mt-2 px-8 mb-6">There are no units available to view in this project yet.</Text>
              </View>
            ) : activeTower ? (
          <>
            <InventoryFilters
