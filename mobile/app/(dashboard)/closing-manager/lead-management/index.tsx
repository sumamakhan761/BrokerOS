...
export default function ClosingManagerLeadManagementList() {
  ...
  if (loading) {
    return (
      <View className="flex-1 justify-center items-center bg-[#f8fafc]">
        ...
        <Text className="text-gray-500 mt-4 font-medium">Loading closing manager leads...</Text>
      </View>
    );
  }
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <LeadListItem
            ...
            onPressLead={(id) => router.push({ pathname: '/(dashboard)/closing-manager/lead-management/[id]', params: { id } } as any)}
            onLongPressLead={(id) => {
        ...
        contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 100 }} // Extra padding for FAB
        showsVerticalScrollIndicator={false}
      />

      {/* Floating Action Button for New Lead */}
      {!selectionMode && (
        <TouchableOpacity
