...
export default function BookingScreen() {
  ...
  const renderBooking = ({ item, index }: { item: any; index: number }) => {
    ...
    return (
      <TouchableOpacity
        activeOpacity={0.7}
        onPress={() => router.push(`/sales-executive/lead-management/${item.customer?.lead?.id}` as any)}
      ...
      <View className="px-5 pt-6 pb-2">
        <View className="flex-row items-center mb-5">
          ...
          <View>
            ...
            <Text className="text-gray-500 text-xs">View finalized bookings</Text>
          </View>
        </View>
        ...
        <View className="flex-row items-center bg-white border border-gray-200 rounded-xl px-4 py-3 mb-2" style={{ elevation: 1, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 2, shadowOffset: { width: 0, height: 1 } }}>
          ...
          <TextInput
            ...
            placeholder="Search name, booking no, or unit..."
