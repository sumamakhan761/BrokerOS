...
interface BrokerMeetingEditModeProps {
  svId: string;
  editForm: any;
...
export default function BrokerMeetingEditMode({ svId, editForm, setEditForm, saving, saveEdit, onCancel }: BrokerMeetingEditModeProps) {
  return (
    <View className="space-y-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm mt-3">
      
      <View className="mb-3">
        <Text className="text-xs font-semibold text-gray-600 mb-1">Satisfaction Level</Text>
      ...
      <View className="mb-3">
        <Text className="text-xs font-semibold text-gray-600 mb-1">Commission Discussed</Text>
        <TextInput
          className="w-full text-sm border border-gray-200 rounded-xl px-4 py-3 bg-gray-50 text-gray-900"
          value={editForm.commissionDiscussed}
          onChangeText={text => setEditForm({ ...editForm, commissionDiscussed: text })}
          placeholder="e.g. 2% or 50k flat"
        />
      </View>
      ...
      <View className="mb-3">
        ...
        <TextInput
          ...
          placeholder="e.g. Send marketing materials"
        />
      </View>
