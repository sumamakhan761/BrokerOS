...
export default function PostSalesLeadManagement() {
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Post-Sales Pipeline</h1>
          <p className="text-slate-500 text-sm mt-1">Manage leads from Booking to Handover</p>
        </div>
      </div>

      <PostSalesLeadTableClient />
    </div>
  );
}
